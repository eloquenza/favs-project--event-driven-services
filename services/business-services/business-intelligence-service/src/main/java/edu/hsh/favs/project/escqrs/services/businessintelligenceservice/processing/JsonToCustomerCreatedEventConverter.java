...
public class JsonToCustomerCreatedEventConverter extends AbstractMessageConverter {
    ...
    @Override
    protected CustomerCreatedEvent convertFromInternal(Message<?> message, Class<?> targetClass, Object conversionHint) {
        log.info("Logging message from inside the converter: " + message);
        Object payload = message.getPayload();
        log.info("Logging payload from inside the converter: " + new String((byte[]) payload,
