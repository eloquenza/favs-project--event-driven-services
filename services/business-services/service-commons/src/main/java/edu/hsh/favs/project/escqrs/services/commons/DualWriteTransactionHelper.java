...
public class DualWriteTransactionHelper {
  ...
  public static <EntityT, DomainEventBaseT extends DomainEventBase<? extends Number, EntityT>>
      Mono<EntityT> createEntityControlFlowTemplate(
  ...
  private static <EntityT, DomainEventBaseT extends DomainEventBase<? extends Number, EntityT>>
    ...
    return Mono.fromRunnable(
        () -> {
          ...
          try {
            ...
            Message<? extends DomainEventBase<?, ?>> message =
